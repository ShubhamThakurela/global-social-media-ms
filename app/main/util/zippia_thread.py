from ..service.zippia_service import crawl_by_file, get_url_to_scrap
from ..service.zippia_service import data_to_file ,zipdir
...
def run(url_list, file_path, barrier, out_path):
    ...
    data_to_file(df2, "zippia_scrapped_data_out", out_path)
